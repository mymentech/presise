...
<div class="site" id="page">
    ...
    <div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
		...
		<?php
		$presise_page_meta = get_post_meta( get_the_ID(), '_presise_page_metaboxes', true );
		if ( isset( $presise_page_meta['hero_switch'] ) && $presise_page_meta['hero_switch'] == 'hero_slider' ) :?>
            <div class="presise-slider-wrapper">
                <div class="presise-slider">
					<?php
					$presise_slides = $presise_page_meta['hero_slides'];
            ...
            <nav class="navbar navbar-expand-md navbar-dark bg-transparent">
				...
				<?php endif; ?>
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown"
                            ...
                            aria-label="<?php esc_attr_e( 'Toggle navigation', 'presise' ); ?>">
